...
public class EventLogs {
    ...
    private static String generateEventLog(LogDetails logDetails) {
        ...
        return String.format("%s: %s Database has been changed\n"+
                ...
                "%s rows affected\n",timeStamp.toString(),logDetails.getDatabaseName(),logDetails.getOperationName(),logDetails.getRowsAffected());
    }
    ...
    private static String generateCrashReport(LogDetails logDetails){
        ...
        return String.format("\n---------------------------------------------------------------------------------------------------------------------\n"
                ...
                +"Error Message: %s",timeStamp.toString(),logDetails.getOperationName(),logDetails.getDatabaseName(),logDetails.getTableName(),logDetails.getErrorMessage());
    }
